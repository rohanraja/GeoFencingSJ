...
public class PolygonChecker
{
	...
	private PolygonChecker(List<Line> sides, BoundingBox boundingBox)
	{
		_sides = sides;
	...
	public static class Builder
	{
		...
		public PolygonChecker build()
		{
			...
			PolygonChecker polygon = new PolygonChecker(_sides, _boundingBox);
			return polygon;
		}
